    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      <div className="glass-card rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between border-l-4 border-l-orange-500 bg-gradient-to-r from-white to-orange-50/30">
        <div>
          ...
          <p className="text-gray-600">Connect your Freighter wallet to receive escrow payouts directly on the Stellar network.</p>
        </div>
      </div>
        ...
        {isConnected ? (
          ...
          <div className="text-center py-10">
            ...
            <p className="text-gray-600 max-w-md mx-auto mb-8">
              You need the Freighter browser extension to receive payments on the Stellar network.
            </p>
            <a 
              href={installUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition-colors inline-flex items-center gap-2 shadow-lg"
            >
          ...
          <div className="text-center py-10">
            ...
            <p className="text-gray-600 max-w-md mx-auto mb-8">
              Link your Freighter wallet to receive your earnings instantly when clients release escrow funds.
            </p>
            <button 
              onClick={connect}
              disabled={isConnecting}
              className="px-8 py-3 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition-all shadow-lg inline-flex items-center gap-2 disabled:opacity-70"
            >
              {isConnecting ? (
                <>
